		...
		button.addActionListener((l -> 
				{
						...
						if(lastPitStones == 1 && endingSide.equals(player) && !(pitKeys.get(currentIndex).equals("AM") || pitKeys.get(currentIndex).equals("BM") ) ) { 
							//pit was empty and is on current player's side and is not a mancala = take stones from opponent
							String opponentPit;
